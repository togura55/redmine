class ButtonCustomfieldCustomfieldHook < Redmine::Hook::ViewListener
  ...
  def view_custom_fields_form_upper_box(context = { })
      context[:controller].send(:render_to_string, {
        :partial => "view_custom_fields_form_upper_box_button_customfield_patch", # app\views\custom_fields
