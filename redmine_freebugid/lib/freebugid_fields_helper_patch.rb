...
module FreebugidFieldsHelperPatch
    ...
    def self.included(base)
        ...
        base.class_eval do
            ...
            alias_method       :show_value,                     :show_freebugid_value
            alias_method_chain :custom_field_tag,               :freebugid
            alias_method_chain :custom_field_tag_for_bulk_edit, :freebugid
        end
    end

    module InstanceMethods

        def show_freebugid_value(custom_value, html = true)
        ...
        def custom_field_tag_with_freebugid(prefix, custom_value)
            custom_field = custom_value.custom_field

            tag = custom_field_tag_without_freebugid(prefix, custom_value)
        ...
        def custom_field_tag_for_bulk_edit_with_freebugid(prefix, custom_field, objects = nil, value = '')
            tag = custom_field_tag_for_bulk_edit_without_freebugid(prefix, custom_field, objects, value)
    ...
    module ObsoleteMethods
        ...
        def show_freebugid_value(custom_value)
            if custom_value
                begin
        ...
        def custom_field_tag_with_freebugid(name, custom_value)
            custom_field = custom_value.custom_field
            ...
            when 'project'
                ...
                tag = custom_field_tag_without_freebugid(name, custom_value)
            end
        ...
        def custom_field_tag_for_bulk_edit_with_freebugid(name, custom_field, projects = nil)
            field_name = "#{name}[custom_field_values][#{custom_field.id}]"
            ...
            when 'project'
                ...
                tag = custom_field_tag_for_bulk_edit_without_freebugid(name, custom_field, projects)
            end
